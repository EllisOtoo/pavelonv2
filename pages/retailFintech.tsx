...
function CommercialFintechs() {
  ...
  return (
    <>
      ...
      <HeaderUseCases
        hidden
        title="Open accounts, issue cards, and facilitate payments"
        subHeader={"For Retail Fintechs"}
      />
      <hr />
      {/* {["", "", "", " "].map((imageUrl) => (
        <div>
      ...
      <OfferSection
        bgColor="bg-gray-100"
        caption="Benefits"
        subheader="Building your Retail fintech with Pavelon"
        featureSubheader={[
...
export default CommercialFintechs;
